...
static __initdata struct tegra_pingroup_config cardhu_pinmux_common[] = {
	...
	VI_PINMUX(VI_D11,          RSVD1,           NORMAL,    NORMAL,     INPUT, DISABLE, DISABLE),
	VI_PINMUX(VI_MCLK,         VI,              NORMAL,   NORMAL,     OUTPUT, DISABLE, DISABLE),
	...
	DEFAULT_PINMUX(DAP1_DOUT,       GMI,             NORMAL,    NORMAL,     OUTPUT),
	...
	/* SDMMC1 WP gpio */
	DEFAULT_PINMUX(SPI2_SCK,          GMI,           PULL_UP,   NORMAL,     INPUT),
	/* Touch panel GPIO */
	/* Touch IRQ */
	...
	DEFAULT_PINMUX(SPI2_MISO,       GMI,             NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config cardhu_pinmux_cardhu[] = {
	...
	DEFAULT_PINMUX(GPIO_PU4,        RSVD1,           PULL_UP,   NORMAL,     INPUT),
        ...
        DEFAULT_PINMUX(SPI2_MISO,       SPI6,            PULL_UP,    NORMAL,      OUTPUT),
        DEFAULT_PINMUX(SPI2_CS0_N,      GMI,            NORMAL,    NORMAL,      OUTPUT),
        DEFAULT_PINMUX(SPI2_CS2_N,      GMI,            PULL_UP,    NORMAL,     INPUT),
};
