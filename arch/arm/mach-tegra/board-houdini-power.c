...
TPS_PDATA_INIT(ldo1, 0,         1000, 3300, tps6591x_rails(VDD_2), 1, 1, 1, -1, 0, 1, 0, 0);
...
TPS_PDATA_INIT(ldo5, e1198,     	3300, 3300, 0, 1, 1, 1, 3300, 0, 0, 0, 0);
		...
		case BOARD_FAB_A03:
			...
			break;
                ...
                pdata_ldo1_0.regulator.num_consumer_supplies =
                                        ARRAY_SIZE(tps6591x_ldo1_supply_0);
                pdata_ldo1_0.regulator.consumer_supplies =
                                        tps6591x_ldo1_supply_0;
#endif
...
#endif
printk("%s !!!Error: should not be here!!\n", __func__);
	}
...
/*EN_USB2_VBUS_OC*/
static struct regulator_consumer_supply fixed_reg_en_usb2_vbus_oc_supply[] = {
	REGULATOR_SUPPLY("vdd_vbus_typea2_usb", NULL),
};
/*EN_USB3_VBUS_OC*/
...
FIXED_REG(5, en_3v3_modem,	en_3v3_modem,	NULL,				1,      0,      TEGRA_GPIO_PV1,		true,	1, 3300);
FIXED_REG(6, en_vdd_pnl1,	en_vdd_pnl1,	FIXED_SUPPLY(en_3v3_sys),	0,      0,      TEGRA_GPIO_PB2,		true,	1, 3300);
...
FIXED_REG(9, en_3v3_fuse,	en_3v3_fuse,	FIXED_SUPPLY(en_3v3_sys), 	1,      0,      TEGRA_GPIO_PX0,		true,	1, 3300);
FIXED_REG(10, en_3v3_emmc,	en_3v3_emmc,	FIXED_SUPPLY(en_3v3_sys), 	1,      0,      TEGRA_GPIO_PD1,		true,	1, 3300);
FIXED_REG(11, en_vdd_sdmmc1,	en_vdd_sdmmc1,	FIXED_SUPPLY(en_3v3_sys), 	0,      0,      TEGRA_GPIO_PC1,		true,	1, 3300);
FIXED_REG(12, en_3v3_pex_hvdd,	en_3v3_pex_hvdd, FIXED_SUPPLY(en_3v3_sys),	0,      0,      TEGRA_GPIO_PX1,		true,	0, 3300);
...
FIXED_REG(18, cam1_ldo_en,	cam1_ldo_en,	FIXED_SUPPLY(en_3v3_sys),	0,      0,      TEGRA_GPIO_PR6,		true,	1, 2800);
FIXED_REG(19, cam2_ldo_en,	cam2_ldo_en,	FIXED_SUPPLY(en_3v3_sys),	0,      0,      TEGRA_GPIO_PS0,		true,	1, 2800);
...
FIXED_REG_OD(15, en_usb1_vbus_oc,	en_usb1_vbus_oc,	FIXED_SUPPLY(en_5v0),		0,      0,      TEGRA_GPIO_PH5,		true,	0, 5000, true);
FIXED_REG_OD(16, en_usb3_vbus_oc,	en_usb3_vbus_oc, 	FIXED_SUPPLY(en_5v0), 		0,      0,      TEGRA_GPIO_PH7,		true,	0, 5000, true);
FIXED_REG_OD(17, en_usb2_vbus_oc,	en_usb2_vbus_oc,	FIXED_SUPPLY(en_5v0), 		0,      0,      TEGRA_GPIO_PI2,	true,	0, 5000, true);

/* E1198/E1291 specific  fab >= A03 */
FIXED_REG_OD(15, en_usb1_vbus_oc_a03,	en_usb1_vbus_oc,	FIXED_SUPPLY(en_5v0),		0,      0,      TEGRA_GPIO_PH5,	true,	0, 5000, true);
FIXED_REG_OD(16, en_usb3_vbus_oc_a03,	en_usb3_vbus_oc,	FIXED_SUPPLY(en_5v0), 		0,      0,      TEGRA_GPIO_PH7,	true,	0, 5000, true);
FIXED_REG_OD(17, en_usb2_vbus_oc_a03,	en_usb2_vbus_oc,	FIXED_SUPPLY(en_5v0), 		0,      0,      TEGRA_GPIO_PI2,	true,	0, 5000, true);

/* E1198/E1291 specific */
FIXED_REG_OD(23, en_vddio_vid_oc,	en_vddio_vid_oc,	FIXED_SUPPLY(en_5v0), 		0,      0,      TEGRA_GPIO_PN6,		true,	0, 5000, true);
...
#define E1291_1198_A00_FIXED_REG		\
	...
	ADD_FIXED_REG(en_usb2_vbus_oc),

#define E1291_A03_FIXED_REG			\
	ADD_FIXED_REG(en_usb1_vbus_oc_a03),	\
	ADD_FIXED_REG(en_usb2_vbus_oc_a03),	\
...
printk("Board ID is %d (%x)\n",board_info.board_id, board_info.board_id); 
...
for (i = 0; i <  nfixreg_devs; i++ )
	{
		printk("Registering regulator %s\n", fixed_reg_devs[i]->name);
		platform_device_register(fixed_reg_devs[i]);
	}
return 1;
}
